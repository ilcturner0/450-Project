...
/**
 * Primary, creates API call to create a mapped collection of data.
 * Map is then passed to return function to render HTML file for user diplay.
 * 
 * */
...
function App() {
    ...
    const getPokemon = async () => {
        ...
        try {
            ...
            //Sets background color based on pokemon's primary type
    ...
    //returns rendered HTML page based on mapped pokemon Data
    return (
        <div className="App">
